...
public class MainActivity extends AppCompatActivity {
        ...
        switch (item.getItemId()) {
            case R.id.mnxModificar:
                try {
                    ...
                    Intent iusuario = new Intent(MainActivity.this, AgregarAmigos.class);
    ...
    public AlertDialog eliminar(){
        ...
        confirmacion.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.cancel();
                Toast.makeText(MainActivity.this, "El registro se elimino satisfactoriamente."
                        , Toast.LENGTH_LONG).show();
            }
        });
    ...
    public  void registrar_amigos(View v){
        Intent iagregar = new Intent(MainActivity.this, AgregarAmigos.class);
